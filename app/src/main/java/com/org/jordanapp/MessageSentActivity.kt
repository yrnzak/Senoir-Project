...
import com.org.jordanapp.adapters.MessageSentAdapter
...
class MessageSentActivity : AppCompatActivity() {
    ...
    private lateinit var messageAdapter: MessageSentAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Sent"

        messageListView = findViewById(R.id.messageListView)
        messageAdapter = MessageSentAdapter(this, messages)
    ...
    private fun showFullMessageDialog(message: Message) {
        ...
        dialogBuilder.setTitle("Message To ${message.recipientEmail}")
